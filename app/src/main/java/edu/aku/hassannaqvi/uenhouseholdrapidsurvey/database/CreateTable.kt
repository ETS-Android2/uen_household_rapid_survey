...
*/
    ...
    const val SQL_CREATE_PREGNANCY_DETAILS = ("CREATE TABLE "
            ...
            + PregnancyDetailsTable.COLUMN_MUID + " TEXT,"
            + PregnancyDetailsTable.COLUMN_FMUID + " TEXT,"
            + PregnancyDetailsTable.COLUMN_PSU_CODE + " TEXT,"
            + PregnancyDetailsTable.COLUMN_SNO + " TEXT,"
            + PregnancyDetailsTable.COLUMN_M_SNO + " TEXT,"
            ...
            + PregnancyDetailsTable.COLUMN_INDEXED + " TEXT,"
