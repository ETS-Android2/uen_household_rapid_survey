...
import edu.aku.hassannaqvi.uenhouseholdrapidsurvey.databinding.ActivitySectionImactivityBinding;

public class SectionIMActivity extends AppCompatActivity {

    private static final String TAG = "SectionIMActivity";
    ActivitySectionImactivityBinding bi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.sectionimimmunizationinformation_mainheading);
